/**
 * @fileoverview
 * This script defines a generic model class for MVC widgets and applications.
 ...
 * @constructor
 */
flyui.mvcutils.GenericModel2 = function() {};
	
/**
 * @private
 */
flyui.mvcutils.GenericModel2.prototype._state = null;
	
/**
 * @private
 */
flyui.mvcutils.GenericModel2.prototype._events = null;

/**
 * @private
 */
flyui.mvcutils.GenericModel2.prototype._properties = null;

/**
 * @private
 */
flyui.mvcutils.GenericModel2.prototype._values = null;
...
flyui.mvcutils.GenericModel2.prototype._init = function( definition ) {
	...
	if (typeof definition == "object") {
		...
		else throw new flyui.mvcutils.GenericModel2.BadDefinition("definition must have 'properties' field with array value");
		
		// store values
		if (typeof definition.values == "object") {
			this._values = definition.values;
		}
		else throw new flyui.mvcutils.GenericModel2.BadDefinition("definition must have 'values' field with object value");
		...
		else throw new flyui.mvcutils.GenericModel2.BadDefinition("definition must have 'initialize' field with function value");		
		
	}
	else throw new flyui.mvcutils.GenericModel2.BadDefinition("definition must be an object");		
 ...
 * TODO doc me
 */
flyui.mvcutils.GenericModel2.prototype.getter = function() {
    var self = this;
...
flyui.mvcutils.GenericModel2.prototype._validateProperty = function( property ) {
	...
	if (!valid) {
		throw new flyui.mvcutils.GenericModel2.BadPropertyName("bad property name: "+property);
	}
...
flyui.mvcutils.GenericModel2.prototype._validatePropertyValue = function( property, value ) {
	...
	if (!valid) {
		throw new flyui.mvcutils.GenericModel2.BadPropertyValue("bad property value, property: "+property+", value: "+value);
	}
...
flyui.mvcutils.GenericModel2.BadDefinition = function( message ) {
	this.name = "flyui.mvcutils.GenericModel2.BadDefinition";
	this.message = message;
};

flyui.mvcutils.GenericModel2.BadPropertyName = function( message ) {
	this.name = "flyui.mvcutils.GenericModel2.BadPropertyName";
	this.message = message;
};

flyui.mvcutils.GenericModel2.BadPropertyValue = function( message ) {
	this.name = "flyui.mvcutils.GenericModel2.BadPropertyValue";
	this.message = message;
};
